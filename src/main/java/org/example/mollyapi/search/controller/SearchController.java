...
public class SearchController {
    ...
    public ResponseEntity<SearchItemResDto> search(@ParameterObject SearchOptionReqDto searchOptionReqDto) {


        SearchItemResDto searchItemResDto = searchService.searchItem(searchOptionReqDto);
