...
public class PaymentServiceTest {
    ...
    @DisplayName("PENDING 상태의 주문에 대해 결제를 시도합니다.")
    @Test
    void processPaymentFromPendingOrder() {
        ...
        Payment confirmedPayment = new Payment(1L,"NORMAL",orderAmount,paymentKey,tossOrderId,paymentDate,null,0,null,order,user);
        given(paymentRepository.save(any())).willReturn(confirmedPayment);
